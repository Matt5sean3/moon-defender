...
function DisplayGL(ctx) {
    Display.call(this, ctx);
    this.collectDisplay();
}

DisplayGL.prototype = new Display();

DisplayGL.prototype.processDisplays = function(displays) {
...
DisplayGL.prototype.collectDisplay = function() {
...
DisplayGL.prototype.enableVR = function() {

    if(this.vrDisplay == null) {
        /* VR display is not available, can't enable it */
        return false;
    }
    this.vr = true;
